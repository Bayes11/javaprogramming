...
public class Travel {
    public static void main(String[] args) {
        ...
        if (passport.equalsIgnoreCase("yes")){
            ...
            System.out.println("where do you travel?");

            String toWhere = scan.next();
            ...
            System.out.println("who are traveling with you?");
            String nameOfGuests = scan.nextLine();
            System.out.println(nameOfGuests);

            System.out.println("Your ticket is booked to " + toWhere +" We have charged extra for the " +bags +" bags but you are traveling with " + nameOfGuests + " so we are giving a discount. Your total cost is " + cost );
