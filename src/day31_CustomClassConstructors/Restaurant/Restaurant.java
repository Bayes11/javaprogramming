...
public class Restaurant {
    ...
    public void hireServers( Server [] serversArray){
        servers.addAll(Arrays.asList(serversArray));
    }
    public void hireChef(Chef chef){
        chefs.add(chef);
    }
    public void hirechefs( Chef [] chefsArray){
        chefs.addAll(Arrays.asList(chefsArray));
    }

    public void terminateChef(int employeedID){
        chefs.removeIf(p->p.employeeID == employeedID);
    }
